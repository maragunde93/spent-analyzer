...
def seed_development_data(db: Session) -> None:
    ...
    _expense(db, group.id, mauro.id, mauro.id, date(2026, 5, 14), "DISCO SM 037", "Supermercado", Decimal("163472.90"), category_by_name)
    _expense(
        db,
        group.id,
        mauro.id,
    ...
    _expense(db, group.id, mica.id, mica.id, date(2026, 5, 16), "CARREFOUR EXPRESS", "Supermercado", Decimal("62240.50"), category_by_name)
