...
import type { AuditLog, CashWalletSummary, Category, Currency, DashboardSummary, Expense, HomeGroup, ImportBatch, MercadoPagoIntegration, MercadoPagoSyncResult, ReceiptImport, Subcategory, User } from "./types";
...
export const api = {
  ...
  syncMercadoPago: (homeId: number, userId: number) =>
    request<MercadoPagoSyncResult>(
